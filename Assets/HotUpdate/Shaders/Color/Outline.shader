Shader "Hidden/Outline" {
    Properties {
        ...
        _OutlineColor ("OutlineColor", Color) = (1, 1, 1, 1) // Outline color
        _OutlineAlpha ("OutlineAlpha", Range(0, 1)) = 1 // Outline alpha
        _OutlinePixelWidth ("OutlinePixelWidth", Int) = 1 // Outline pixel width

        _OutlineDistortTex ("OutlineDistortionTex", 2D) = "white" { } // Distortion texture
        _OutlineDistortAmount ("OutlineDistortionAmount", Range(0, 2)) = 0.5 // Distortion amount
        _OutlineDistortTexXSpeed ("OutlineDistortTexXSpeed", Range(-50, 50)) = 5 // X speed
        _OutlineDistortTexYSpeed ("OutlineDistortTexYSpeed", Range(-50, 50)) = 5 // Y speed
    }
    SubShader {
        ...
        Pass {
            ...
            sampler2D _MainTex;
            float4 _MainTex_TexelSize; // Texel size of _MainTex
